  ...
  return db
    .prepare(
      `SELECT budget_items.*, categories.name AS category_name, categories.kind AS category_kind,
              ...
              income_estimates.pension_scheme_type AS estimate_pension_scheme_type,
              income_estimates.pension_contribution_method AS estimate_pension_contribution_method,
